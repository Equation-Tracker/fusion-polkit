...
A polkit authentication agent for Hyprland with a stunning Glassmorphism dark theme. Forked from [quillpolkit](soyeb-jim285/quillpolkit) which originally derived from [hyprpolkitagent](https://github.com/hyprwm/hyprpolkitagent).
